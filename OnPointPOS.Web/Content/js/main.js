...
var Core = function () {
    ...
    var runSideMenu = function () {
		...
		$('.sidebar-menu ul.sub-nav > li > a').click(function (e) {
		   // e.preventDefault();
    ...
    var runDemoJS = function () { 
	   ...
	   $('.toggle-color-swap').on('click',function() {
		   ...
		   if (swapColor === 'bg-white') {
				...
				navbarLogo.attr('src', 'Content/img/logos/header-logo.png');
		   } else {
			   navbar.removeClass(colors).addClass(swapColor + ' navbar-white-text');
			   navbarLogo.attr('src', 'Content/img/logos/header-logo_light.png');
		   }
	   });
        ...
        $(window).load(function() {
			...
			var scripts = {
				...
				// HIGH PRIORITY
				gmap: 'Content/vendor/plugins/map/gmaps.min.js',
				jquerymap: 'Content/vendor/plugins/gmap/jquery.ui.map.js',
				mixitup: 'Content/vendor/plugins/mixitup/jquery.mixitup.min.js',
				mpopup: 'Content/vendor/plugins/mfpopup/jquery.magnific-popup.min.js',
				chosen: 'Content/vendor/plugins/chosen/chosen.jquery.js',
				moment: 'Content/vendor/plugins/daterange/moment.min.js',
				globalize: 'Content/vendor/plugins/globalize/globalize.js',
	
				// FORM PICKERS
				cpicker: 'Content/vendor/plugins/colorpicker/bootstrap-colorpicker.js',
				timepicker: 'Content/vendor/plugins/timepicker/bootstrap-timepicker.min.js',
				datepicker: 'Content/vendor/plugins/datepicker/bootstrap-datepicker.js',
				daterange: 'Content/vendor/plugins/daterange/daterangepicker.js',
				
				// FORMS
				validate: 'Content/vendor/plugins/validate/jquery.validate.js',
				masked: 'Content/vendor/plugins/jquerymask/jquery.maskedinput.min.js',
				
				// FORMS TOOLS
				holder: 'Content/vendor/bootstrap/plugins/holder/holder.js',
				tagmanager: 'Content/vendor/plugins/tags/tagmanager.js',
				gritter: 'Content/vendor/plugins/gritter/jquery.gritter.min.js',
				ladda: 'Content/vendor/plugins/ladda/ladda.min.js',
				paginator: 'Content/vendor/bootstrap/plugins/paginator/bootstrap-paginator.js',
				knob: 'Content/vendor/plugins/jquerydial/jquery.knob.js',
				rangeslider: 'Content/vendor/plugins/rangeslider/jQAllRangeSliders.min.js',
				
				// MED PRIORITY - Large File sizes
				charts: 'Content/js/pages/charts.js',
				ckeditorCDN:     'http://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.0.1/ckeditor.js',
				xedit: 'Content/vendor/editors/xeditable/js/bootstrap-editable.js',
				summernote: 'Content/vendor/editors/summernote/summernote.js',
				countdown: 'Content/vendor/plugins/countdown/jquery.countdown.js',
				jcrop: 'Content/vendor/plugins/imagecrop/jquery.Jcrop.min.js',
				imagezoom: 'Content/vendor/plugins/imagezoom/jquery.elevatezoom.min.js',
				sketchpad: 'Content/vendor/plugins/notepad/wPaint.min.js',
				fileupload: 'Content/vendor/bootstrap/plugins/fileupload/fileupload.js',
			};	
