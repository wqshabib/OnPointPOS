...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            //1 Rafat: change this to :: buttonClass: 'btn btn-default'   to below
          ...
          //Rafat: Changes  this to buttonContainer: '<div class="btn-group"  />',    to below


            buttonContainer: '<div class="btn-group form-control" style="padding:0px;margin:0px;" />',
            ...
            templates: {
                ...
                // Rafat change from  button: '<button type="button" class="multiselect dropdown-toggle" data-toggle="dropdown"></button>'   to below
                button: '<button type="button" class="multiselect dropdown-toggle" data-toggle="dropdown" style="text-align:left;"></button>',
