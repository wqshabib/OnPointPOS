...
namespace POSSUM
{
    public class LogWriter
    {
        ...
        public static void LogException(Exception exc)
        {
            ...
            //24/06/2020: Zahid:  Stop Email Exception sending mail
            //bg.DoWork += Bg_DoWork;
            bg.RunWorkerAsync();
        ...
        public static void JournalLog(int actionid, Guid? orderId, Guid? itemId, int? tableId, string logMessage = "")
        {
            ...
            //{
            //    if (orderId != null)
            //        terminalId = db.OrderMaster.FirstOrDefault(o => o.Id == orderId).TerminalId;
            //}
            Guid terminal = Guid.Parse(Defaults.TerminalId);
            ...
            if (Defaults.User != null && !string.IsNullOrEmpty(Defaults.User.Id))
