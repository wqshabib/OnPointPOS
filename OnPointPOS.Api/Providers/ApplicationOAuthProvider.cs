...
namespace POSSUM.Api.Providers
{
     public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            using (ApplicationUserManager userManager = _userManagerFactory())
            {
                ...
                AuthenticationProperties properties = CreateProperties(user.UserName, user.Id, user.CompanyId.ToString(), user.Email);
        ...
        public static AuthenticationProperties CreateProperties(string userName, string id, string companyId, string email)
        {
            IDictionary<string, string> data = new Dictionary<string, string>
            {
                { "userName", userName }, { "companyId", companyId }, { "userId", id }, { "email", email}
            };
