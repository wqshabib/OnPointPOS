...
namespace POSSUM.StandAloneApi
{
    ...
    public class ApplicationUserManager : UserManager<MasterApplicationUser>
    {
        public ApplicationUserManager(IUserStore<MasterApplicationUser> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<MasterApplicationUser>(context.Get<MasterDbContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<MasterApplicationUser, string>
    {
