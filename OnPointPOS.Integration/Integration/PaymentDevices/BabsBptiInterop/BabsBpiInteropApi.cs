using BPTIInterop;
using POSSUM.Integration.PaymentDevices.BabsBpti;
using System;
...
{
    public class BabsBpiInteropApi
    {
...
onRetail\POSSUM\Integration\PaymentDevices\BabsBpti\BPTIInterop.dll          
        ...
        */
        public BabsBpiInteropApi(string paymentDeviceTypeConnectionString, Dispatcher dispatcher)
        {
            this.LastStatus = 0;
        ...
        public class BabsEventHandler : ICoBpTiEvents
        {
            private BabsBpiInteropApi babsBpiApi;
            private IPaymentDeviceEventHandler eventHandler;

            public BabsEventHandler(BabsBpiInteropApi babsBpiApi, IPaymentDeviceEventHandler eventHandler)
            {
        ...
        public bool Connect()
        {
            ...
            if (uri.Scheme.ToLower() == "babstcp")
            {
                ...
                //Debug.WriteLine(TAG + "SND (Connect)");
                api.connect();
                isConnected = true;
            }
            return isConnected;
