...
{
    public class BabsBptiPaymentDevice : IPaymentDevice
    {
        private string paymentDeviceTypeConnectionString;
        private int cookie;
        private volatile BabsBpiApi api;
        ...
        public BabsBptiPaymentDevice(string paymentDeviceTypeConnectionString)
        {
        ...
        public bool Connect()
        {
            ...
            runInBackground(() =>
            {
                api = new BabsBpiApi(paymentDeviceTypeConnectionString, dispatcher);
        ...
        public void StartTransaction(PaymentTransactionType transactionType)
        {
            ...
            switch (transactionType)
            {
                case PaymentTransactionType.PURCHASE:
                    api.StartTransaction(BabsBpiApi.TransactionTypes.LPP_PURCHASE);
                    break;
                case PaymentTransactionType.REFUND:
                    api.StartTransaction(BabsBpiApi.TransactionTypes.LPP_REFUND);
                    break;
                case PaymentTransactionType.REVERSAL:
                    api.StartTransaction(BabsBpiApi.TransactionTypes.LPP_REVERSAL);
                    break;
                case PaymentTransactionType.BATCH:
                    api.StartTransaction(BabsBpiApi.TransactionTypes.LPP_CLOSEBATCH);
                    break;
            }
            //});
        }
